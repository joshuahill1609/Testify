...
saved it on your computer. Give it test drive at [test-ify.com](http://www.test-ify.com). 
...
* Fix pdf formatting.
* Change design to make question Drag & Drop in test builder user friendly.
* Change CSS sizing on sign up page.
* Change user management over to Devise.
